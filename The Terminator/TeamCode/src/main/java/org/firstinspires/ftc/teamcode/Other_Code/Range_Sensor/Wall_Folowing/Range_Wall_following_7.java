...
@TeleOp(name = "Follow .7", group = "Wall")
@Disabled
public class Range_Wall_following_7 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (gamepad1.guide){
            ...
            while (opModeIsActive()) {
                ...
                double leftPower7 = (range * -.1) + 1.3;
                double rightPower7 = (range * .1) - .6;

                telemetry.addData("leftPower", leftPower7);
                telemetry.addData("rightPower", rightPower7);

                leftPower7 = Range.clip(leftPower7, 0, 1);
                rightPower7 = Range.clip(rightPower7, 0, 1);

                robot.leftMotor.setPower(leftPower7);
                robot.rightMotor.setPower(rightPower7);
