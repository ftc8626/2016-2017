 ...
 */
@Autonomous(name = "Auto_Code_Move_Red_Po.1_Menu", group = "Gyro")
@Disabled
public class Test_Auto_Code_Move_Red_Po1_Menu extends LinearOpMode{
    ...
    public final String BEACONS = "BEACONS";
    public final String BEACONS_TRUE = "YES";
    public final String BEACONS_FALSE = "NO";
    ...
    public void runOpMode()throws InterruptedException {
        ...
        //auto drive
       public void Lets_Move(MenuChoices menuChoices) throws Exception,InterruptedException {
        if (menuChoices.getBeacon() == BEACONS_TRUE) {
...
//            drive(45, -1);
    ...
    private void InitializeMenu() throws InterruptedException{
        ...
        SingleSelectCategory shouldPark = new SingleSelectCategory(BEACONS);
        shouldPark.addOption(BEACONS_TRUE);
        shouldPark.addOption(BEACONS_FALSE);
