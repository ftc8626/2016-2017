...
@TeleOp(name = "Follow .6", group = "Wall")
@Disabled
public class Range_Wall_following_6 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (gamepad1.guide){
            ...
            while (opModeIsActive()) {
                ...
                double leftPower6 = (range * -.08571429) +1.11428571;
                double rightPower6 = (range * .08571429) - .51428571;

                telemetry.addData("leftPower", leftPower6);
                telemetry.addData("rightPower", rightPower6);

                 leftPower6 = Range.clip(leftPower6, 0, 1);
                rightPower6 = Range.clip(rightPower6, 0, 1);

                robot.leftMotor.setPower(leftPower6);
                robot.rightMotor.setPower(rightPower6);
