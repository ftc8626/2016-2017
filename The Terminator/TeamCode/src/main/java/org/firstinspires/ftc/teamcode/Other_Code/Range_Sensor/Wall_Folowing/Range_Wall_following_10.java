...
@TeleOp(name = "Follow 1", group = "Wall")
@Disabled
public class Range_Wall_following_10 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (gamepad1.guide){
            ...
            while (opModeIsActive()) {
                ...
                double leftPower = (range * -.14285714) + 1.85714286;
                double rightPower = (range * .14285714) - .85714286;
