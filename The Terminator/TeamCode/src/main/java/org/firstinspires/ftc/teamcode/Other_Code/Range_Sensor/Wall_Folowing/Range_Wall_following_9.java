...
@TeleOp(name = "Follow .9", group = "Wall")
@Disabled
public class Range_Wall_following_9 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (gamepad1.guide){
            ...
            while (opModeIsActive()) {
                ...
                double leftPower9 = (range * -.12857143) + 1.67142857;
                double rightPower9 = (range * .12857143) - .51428571;

                telemetry.addData("leftPower", leftPower9);
                telemetry.addData("rightPower", rightPower9);

                leftPower9 = Range.clip(leftPower9, 0, 1);
                rightPower9 = Range.clip(rightPower9, 0, 1);

                robot.leftMotor.setPower(leftPower9);
                robot.rightMotor.setPower(rightPower9);
