...
//      // the lower 4 bits, a "1" sets the commanded Self Blue_Right bit, which causes self-test to run (p. 46)
//
...
//        snooze(250);//Give the data time to go from the Interface Module to the IMU hardware
//        readingEnabled = true;
//      } else {//Check the Calibration Status and Self-Blue_Right bytes in the Read Cache. IMU datasheet
...
//            // calinbrated.
//            //Also on that page: Self-Blue_Right byte value of 0X0F means everything passed self-test.
